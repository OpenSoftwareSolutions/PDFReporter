...
- (id)createObjectWithOrgOssPdfreporterXmlParsersIAttributes:(id<OrgOssPdfreporterXmlParsersIAttributes>)atts {
  ...
  OrgOssPdfreporterEngineDesignJRDesignEllipse *ellipse = [[OrgOssPdfreporterEngineDesignJRDesignEllipse alloc] initWithOrgOssPdfreporterEngineJRDefaultStyleProvider:jasperDesign];
  return ellipse;
}
