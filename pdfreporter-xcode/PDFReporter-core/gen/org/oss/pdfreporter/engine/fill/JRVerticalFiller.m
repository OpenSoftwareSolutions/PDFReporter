...
static JavaUtilLoggingLogger * OrgOssPdfreporterEngineFillJRVerticalFiller_logger_;

+ (JavaUtilLoggingLogger *)logger {
  return OrgOssPdfreporterEngineFillJRVerticalFiller_logger_;
}
...
- (id)initWithOrgOssPdfreporterEngineJasperReportsContext:(id<OrgOssPdfreporterEngineJasperReportsContext>)jasperReportsContext
  ...
  return [self initOrgOssPdfreporterEngineFillJRVerticalFillerWithOrgOssPdfreporterEngineJasperReportsContext:jasperReportsContext withOrgOssPdfreporterEngineJasperReport:jasperReport withOrgOssPdfreporterEngineFillJREvaluator:nil withOrgOssPdfreporterEngineFillJRFillSubreport:nil];
}
...
- (id)initOrgOssPdfreporterEngineFillJRVerticalFillerWithOrgOssPdfreporterEngineJasperReportsContext:(id<OrgOssPdfreporterEngineJasperReportsContext>)jasperReportsContext
                                                             withOrgOssPdfreporterEngineJasperReport:(OrgOssPdfreporterEngineJasperReport *)jasperReport
...
- (id)initWithOrgOssPdfreporterEngineJasperReportsContext:(id<OrgOssPdfreporterEngineJasperReportsContext>)jasperReportsContext
               ...
               withOrgOssPdfreporterEngineFillJREvaluator:(OrgOssPdfreporterEngineFillJREvaluator *)evaluator
           withOrgOssPdfreporterEngineFillJRFillSubreport:(OrgOssPdfreporterEngineFillJRFillSubreport *)parentElement {
  return [self initOrgOssPdfreporterEngineFillJRVerticalFillerWithOrgOssPdfreporterEngineJasperReportsContext:jasperReportsContext withOrgOssPdfreporterEngineJasperReport:jasperReport withOrgOssPdfreporterEngineFillJREvaluator:evaluator withOrgOssPdfreporterEngineFillJRFillSubreport:parentElement];
}
      ...
      if ([self next]) {
        ...
        switch ([whenNoDataType_ ordinal]) {
          case OrgOssPdfreporterEngineTypeWhenNoDataTypeEnum_ALL_SECTIONS_NO_DETAIL:
          {
            ...
            [self fillColumnHeaderWithChar:OrgOssPdfreporterEngineJRExpression_EVALUATION_DEFAULT];
...
- (void)fillColumnHeaderWithChar:(char)evaluation {
  [self setNewPageColumnInBands];
  ...
  if ([((OrgOssPdfreporterEngineFillJRFillBand *) nil_chk(columnHeader_)) isToPrint]) {
    ...
    [self setOffsetX];
    BOOL filled = [self fillBandNoOverflowWithOrgOssPdfreporterEngineFillJRFillBand:columnHeader_ withChar:evaluation];
    for (int i = 0; !filled && i < reattempts; ++i) {
      while (columnIndex_ < columnCount_ - 1) {
        [self resolveGroupBoundElementsWithChar:evaluation withBOOL:NO];
        [self resolveColumnBoundElementsWithChar:evaluation];
        [((OrgOssPdfreporterEngineJRAbstractScriptlet *) nil_chk(scriptlet_)) callBeforeColumnInit];
        [((OrgOssPdfreporterEngineFillJRCalculator *) nil_chk(calculator_)) initializeVariablesWithOrgOssPdfreporterEngineTypeResetTypeEnumEnum:[OrgOssPdfreporterEngineTypeResetTypeEnumEnum COLUMN] withOrgOssPdfreporterEngineTypeIncrementTypeEnumEnum:[OrgOssPdfreporterEngineTypeIncrementTypeEnumEnum COLUMN]];
        [((OrgOssPdfreporterEngineJRAbstractScriptlet *) nil_chk(scriptlet_)) callAfterColumnInit];
        columnIndex_ += 1;
        [self setOffsetX];
        offsetY_ = columnHeaderOffsetY_;
        [self setColumnNumberVar];
      }
      ...
      filled = [self fillBandNoOverflowWithOrgOssPdfreporterEngineFillJRFillBand:columnHeader_ withChar:evaluation];
    }
    if (!filled) {
      @throw [[OrgOssPdfreporterEngineJRRuntimeException alloc] initWithNSString:@"Infinite loop creating new page due to column header overflow."];
    }
  }
  isNewColumn_ = YES;
...
- (OrgOssPdfreporterEngineFillSavePoint *)fillGroupHeaderWithOrgOssPdfreporterEngineFillJRFillGroup:(OrgOssPdfreporterEngineFillJRFillGroup *)group {
  ...
  if (([((OrgOssPdfreporterEngineFillJRFillGroup *) nil_chk(group)) isStartNewPage] || [((OrgOssPdfreporterEngineFillJRFillGroup *) nil_chk(group)) isResetPageNumber]) && !isNewPage_) {
  ...
  else if ([((OrgOssPdfreporterEngineFillJRFillGroup *) nil_chk(group)) isStartNewColumn] && !isNewColumn_) {
    [self fillColumnBreakWithChar:evalPrevPage withChar:OrgOssPdfreporterEngineJRExpression_EVALUATION_DEFAULT];
  }
...
- (void)fillGroupHeaderReprintWithOrgOssPdfreporterEngineFillJRFillGroup:(OrgOssPdfreporterEngineFillJRFillGroup *)group
  ...
  if ([((OrgOssPdfreporterEngineFillJRFillGroup *) nil_chk(group)) isReprintHeaderOnEachPage] && (![((OrgOssPdfreporterEngineFillJRFillGroup *) nil_chk(group)) hasChanged] || ([((OrgOssPdfreporterEngineFillJRFillGroup *) nil_chk(group)) hasChanged] && [((OrgOssPdfreporterEngineFillJRFillGroup *) nil_chk(group)) isHeaderPrinted]))) {
    ...
    for (int i = 0; i < (int) [((IOSObjectArray *) nil_chk(groupHeaderBands)) count]; i++) {
      ...
      if ([((OrgOssPdfreporterEngineFillJRFillBand *) nil_chk(groupHeaderBand)) isToPrint]) {
        while ([((OrgOssPdfreporterEngineFillJRFillBand *) nil_chk(groupHeaderBand)) getBreakHeight] > columnFooterOffsetY_ - offsetY_ || [((OrgOssPdfreporterEngineFillJRFillGroup *) nil_chk(group)) getMinHeightToStartNewPage] > columnFooterOffsetY_ - offsetY_) {
          [self fillColumnBreakWithChar:evaluation withChar:evaluation];
        }
...
- (void)fillDetail {
  ...
  for (int i = 0; i < (int) [((IOSObjectArray *) nil_chk(detailBands)) count]; i++) {
    ...
    if ([((OrgOssPdfreporterEngineFillJRFillBand *) nil_chk(detailBand)) isToPrint]) {
      while ([((OrgOssPdfreporterEngineFillJRFillBand *) nil_chk(detailBand)) getBreakHeight] > columnFooterOffsetY_ - offsetY_) {
  ...
  if (detailBands != nil) {
    for (int i = 0; i < (int) [detailBands count]; i++) {
      ...
      if ([((OrgOssPdfreporterEngineFillJRFillBand *) nil_chk(detailBand)) isToPrint]) {
        (void) [self fillColumnBandWithOrgOssPdfreporterEngineFillJRFillBand:detailBand withChar:OrgOssPdfreporterEngineJRExpression_EVALUATION_DEFAULT];
        isFirstPageBand_ = NO;
        isFirstColumnBand_ = NO;
      }
    }
...
- (void)fillColumnFooterWithChar:(char)evaluation {
  [self setOffsetX];
  if ([self isSubreport] && ![self isSubreportRunToBottom] && columnIndex_ == 0) {
    columnFooterOffsetY_ = offsetY_;
  }
  int oldOffsetY = offsetY_;
  ...
  if ([((OrgOssPdfreporterEngineFillJRFillBand *) nil_chk(columnFooter_)) isToPrint]) {
    [self fillFixedBandWithOrgOssPdfreporterEngineFillJRFillBand:columnFooter_ withChar:evaluation];
  }
  if (isFloatColumnFooter_ && ![((OrgOssPdfreporterEngineFillJRFillContext *) nil_chk(fillContext_)) isIgnorePagination]) {
    offsetY_ += columnFooterOffsetY_ - oldOffsetY;
  }
}
...
- (void)fillSummaryNoLastFooterSamePage {
  ...
  if (summary_ != missingFillBand_ && [((OrgOssPdfreporterEngineFillJRFillBand *) nil_chk(summary_)) isToPrint]) {
    ...
    if ([((OrgOssPdfreporterEngineFillJRFillBand *) nil_chk(summary_)) willOverflow] && [((OrgOssPdfreporterEngineFillJRFillBand *) nil_chk(summary_)) isSplitPrevented]) {
      [self fillColumnFooterWithChar:OrgOssPdfreporterEngineJRExpression_EVALUATION_DEFAULT];
...
- (void)setColumnNumberVar {
  OrgOssPdfreporterEngineFillJRFillVariable *columnNumber = [((OrgOssPdfreporterEngineFillJRCalculator *) nil_chk(calculator_)) getColumnNumber];
  [((OrgOssPdfreporterEngineFillJRFillVariable *) nil_chk(columnNumber)) setValueWithId:[JavaLangInteger valueOfWithInt:columnIndex_ + 1]];
  [((OrgOssPdfreporterEngineFillJRFillVariable *) nil_chk(columnNumber)) setOldValueWithId:[((OrgOssPdfreporterEngineFillJRFillVariable *) nil_chk(columnNumber)) getValue]];
}
...
- (void)fillPageBreakWithBOOL:(BOOL)isResetPageNumber
  ...
  [self fillColumnFooterWithChar:evalPrevPage];
  ...
  [self fillColumnHeaderWithChar:evalNextPage];
...
- (void)fillColumnBreakWithChar:(char)evalPrevPage
                       withChar:(char)evalNextPage {
  if (columnIndex_ == columnCount_ - 1) {
    [self fillPageBreakWithBOOL:NO withChar:evalPrevPage withChar:evalNextPage withBOOL:YES];
  }
  else {
    if (keepTogetherSavePoint_ != nil) {
      [keepTogetherSavePoint_ saveEndOffsetYWithInt:offsetY_];
    ...
    [((OrgOssPdfreporterEngineFillJRCalculator *) nil_chk(calculator_)) initializeVariablesWithOrgOssPdfreporterEngineTypeResetTypeEnumEnum:[OrgOssPdfreporterEngineTypeResetTypeEnumEnum COLUMN] withOrgOssPdfreporterEngineTypeIncrementTypeEnumEnum:[OrgOssPdfreporterEngineTypeIncrementTypeEnumEnum COLUMN]];
    [((OrgOssPdfreporterEngineJRAbstractScriptlet *) nil_chk(scriptlet_)) callAfterColumnInit];
    if (keepTogetherSavePoint_ != nil && !((OrgOssPdfreporterEngineFillSavePoint *) nil_chk(keepTogetherSavePoint_)).isNewColumn) {
      [((OrgOssPdfreporterEngineFillSavePoint *) nil_chk(keepTogetherSavePoint_)) removeContent];
    }
    columnIndex_ += 1;
    [self setOffsetX];
...
- (void)setNewGroupInBandsWithOrgOssPdfreporterEngineJRGroup:(id<OrgOssPdfreporterEngineJRGroup>)group {
  ...
  [((OrgOssPdfreporterEngineFillJRFillBand *) nil_chk(noData_)) setNewGroupWithOrgOssPdfreporterEngineJRGroup:group withBOOL:YES];
  if (groups_ != nil && (int) [((IOSObjectArray *) nil_chk(groups_)) count] > 0) {
    for (int i = 0; i < (int) [((IOSObjectArray *) nil_chk(groups_)) count]; i++) {
...
+ (void)initialize {
  if (self == [OrgOssPdfreporterEngineFillJRVerticalFiller class]) {
    OrgOssPdfreporterEngineFillJRVerticalFiller_logger_ = [JavaUtilLoggingLogger getLoggerWithNSString:[[IOSClass classWithClass:[OrgOssPdfreporterEngineFillJRVerticalFiller class]] getName]];
  }
}
