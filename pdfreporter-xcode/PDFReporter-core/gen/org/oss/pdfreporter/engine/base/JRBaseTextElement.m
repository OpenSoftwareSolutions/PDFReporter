...
- (id)initWithOrgOssPdfreporterEngineJRTextElement:(id<OrgOssPdfreporterEngineJRTextElement>)textElement
withOrgOssPdfreporterEngineBaseJRBaseObjectFactory:(OrgOssPdfreporterEngineBaseJRBaseObjectFactory *)factory {
  if ((self = [super initWithOrgOssPdfreporterEngineJRElement:textElement withOrgOssPdfreporterEngineBaseJRBaseObjectFactory:factory])) {
    ...
    lineBox_ = [((id<OrgOssPdfreporterEngineJRLineBox>) nil_chk([((id<OrgOssPdfreporterEngineJRTextElement>) nil_chk(textElement)) getLineBox])) cloneWithOrgOssPdfreporterEngineJRBoxContainer:self];
    paragraph_ = [((id<OrgOssPdfreporterEngineJRParagraph>) nil_chk([((id<OrgOssPdfreporterEngineJRTextElement>) nil_chk(textElement)) getParagraph])) cloneWithOrgOssPdfreporterEngineJRParagraphContainer:self];
...
- (id)clone {
  OrgOssPdfreporterEngineBaseJRBaseTextElement *clone = (OrgOssPdfreporterEngineBaseJRBaseTextElement *) [super clone];
  ((OrgOssPdfreporterEngineBaseJRBaseTextElement *) nil_chk(clone)).lineBox = [((id<OrgOssPdfreporterEngineJRLineBox>) nil_chk(lineBox_)) cloneWithOrgOssPdfreporterEngineJRBoxContainer:clone];
  ((OrgOssPdfreporterEngineBaseJRBaseTextElement *) nil_chk(clone)).paragraph = [((id<OrgOssPdfreporterEngineJRParagraph>) nil_chk(paragraph_)) cloneWithOrgOssPdfreporterEngineJRParagraphContainer:clone];
  return clone;
}
...
- (void)copyAllPropertiesTo:(id)copy {
  ...
  OrgOssPdfreporterEngineBaseJRBaseTextElement *typedCopy = (OrgOssPdfreporterEngineBaseJRBaseTextElement *) copy;
