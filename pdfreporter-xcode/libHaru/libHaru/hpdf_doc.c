...
HPDF_EXPORT(HPDF_STATUS)
MYHPDF_ResetPages  (HPDF_Doc  pdf)
{
    pdf->root_pages = NULL;
    pdf->cur_pages = NULL;
    pdf->cur_page = NULL;
                     ...
                     HPDF_PageLayout   layout)
{
    ...
    if ((int)layout < 0 || layout >= HPDF_PAGE_LAYOUT_EOF)
                   ...
                   HPDF_PageMode   mode)
{
    ...
    if ((int)mode < 0 || mode >= HPDF_PAGE_MODE_EOF)
                    ...
                    const char     *prefix)
{
    ...
    if ((int)style < 0 || style >= HPDF_PAGE_NUM_STYLE_EOF)
