...
- (OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionResult *)executeWithOrgOssPdfreporterUsesNetSourceforgeJevalEvaluator:(OrgOssPdfreporterUsesNetSourceforgeJevalEvaluator *)evaluator
  ...
  JavaUtilArrayList *values = [OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionHelper getTwoStringsAndOneIntegerWithNSString:arguments withUnichar:OrgOssPdfreporterUsesNetSourceforgeJevalEvaluationConstants_FUNCTION_ARGUMENT_SEPARATOR];
  ...
  @try {
    ...
    int index = [((JavaLangInteger *) [((JavaUtilArrayList *) nil_chk(values)) getWithInt:2]) intValue];
