 ...
 */
package org.oss.pdfreporter.engine.export.legacy;
...
public abstract class BorderOffset
{
	 ...
	 * 
	 */
	private static BorderOffset borderOffset = null;
	...
	{
		borderOffset = isLegacy ? LEGACY : DEFAULT;
	}
	...
	public static float getOffset(JRPen pen)
	{
		...
		{
			borderOffset = 
				org.oss.pdfreporter.engine.util.JRProperties.getBooleanProperty(BorderOffset.PROPERTY_LEGACY_BORDER_OFFSET)
				? LEGACY : DEFAULT;
		}
