 ...
 * create a {@link org.oss.pdfreporter.engine.JRDataSource JRDataSource} to be used by the filling process.
 * <p/>
 ...
 * @see org.oss.pdfreporter.engine.query.QueryExecuterFactory
 */
public interface JRQuery extends JRCloneable
{
	 ...
	 * {@link org.oss.pdfreporter.engine.query.QueryExecuterFactory QueryExecuterFactory} is used to create
	 * a {@link org.oss.pdfreporter.engine.query.JRQueryExecuter JRQueryExecuter} instance.  The query executer
