 ...
 * @see org.oss.pdfreporter.engine.query.JRQueryExecuter
...
public interface JRQueryExecuterFactory
{
	 ...
	 * @throws JRException
	 * @deprecated Replaced by {@link QueryExecuterFactory#createQueryExecuter(org.oss.pdfreporter.engine.JasperReportsContext, JRDataset, Map)}.
	 */
