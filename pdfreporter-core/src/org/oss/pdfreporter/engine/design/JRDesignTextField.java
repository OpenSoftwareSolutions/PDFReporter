...
public class JRDesignTextField extends JRDesignTextElement implements JRTextField
{
	...
	private final static Logger logger = Logger.getLogger(JRDesignTextField.class.getName());
	...
	{
		super(null);
		logger.finest("Expression: " + (getExpression()==null ? null : getExpression().getId()));
