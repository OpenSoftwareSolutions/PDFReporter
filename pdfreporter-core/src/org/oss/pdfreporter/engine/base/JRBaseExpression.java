...
import org.oss.pdfreporter.uses.java.util.StringTokenizer;
...
public class JRBaseExpression implements JRExpression, Serializable
{
	...
	private final static Logger logger = Logger.getLogger(JRBaseExpression.class.getName());
	/**
	 *
	 */
	...
	protected JRBaseExpression(JRExpression expression, JRBaseObjectFactory factory, Integer expressionId)
	{
		...
		logger.finest("Add Expression: " + expression.getText() + ", Id=" + id);
		/*   */
