 ...
 * @version $Id: JRTextMeasurerUtil.java 5526 2012-08-01 11:36:41Z teodord $
 * @see JRTextMeasurer
...
public final class JRTextMeasurerUtil
{
	...
	private static final JRSingletonCache<org.oss.pdfreporter.engine.fill.JRTextMeasurerFactory> cache = 
			new JRSingletonCache<org.oss.pdfreporter.engine.fill.JRTextMeasurerFactory>(org.oss.pdfreporter.engine.fill.JRTextMeasurerFactory.class);
	 ...
	 */
	public org.oss.pdfreporter.engine.fill.JRTextMeasurerFactory getTextMeasurerFactory(JRPropertiesHolder propertiesHolder)
	{
	...
	public JRTextMeasurerFactory getFactory(JRPropertiesHolder propertiesHolder)
	{
		...
		{
			@SuppressWarnings("deprecation")
			org.oss.pdfreporter.engine.fill.JRTextMeasurerFactory factory = cache.getCachedInstance(factoryClass);
	...
	public static class WrappingTextMeasurerFactory implements JRTextMeasurerFactory
	{
		...
		public WrappingTextMeasurerFactory(org.oss.pdfreporter.engine.fill.JRTextMeasurerFactory factory)
		{
