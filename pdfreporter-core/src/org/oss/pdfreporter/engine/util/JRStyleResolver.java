 ...
 * @version $Id: JRStyleResolver.java 5632 2012-09-04 07:48:16Z teodord $
 */
public final class JRStyleResolver
{
	 ...
	 *
	 */
	public static IColor getForecolor(JRCommonElement element)
	{
		IColor ownForecolor = element.getOwnForecolor();
		...
		if (style != null)
		{
			IColor forecolor = style.getForecolor();
			if (forecolor != null)
			{
				return forecolor;
			}
	 ...
	 *
	 */
	public static IColor getForecolor(JRStyle style)
	{
		IColor ownForecolor = style.getOwnForecolor();
		if (ownForecolor != null)
		{
			return ownForecolor;
		}
	 ...
	 *
	 */
	public static IColor getBackcolor(JRCommonElement element)
	{
		IColor ownBackcolor = element.getOwnBackcolor();
		...
		if (style != null)
		{
			IColor backcolor = style.getBackcolor();
			if (backcolor != null)
			{
				return backcolor;
			}
	 ...
	 *
	 */
	public static IColor getBackcolor(JRStyle style)
	{
		IColor ownBackcolor = style.getOwnBackcolor();
		if (ownBackcolor != null)
		{
			return ownBackcolor;
		}
	 ...
	 *
	 */
	public static IColor getLineColor(JRPen pen, IColor defaultColor)
	{
		IColor ownLineColor = pen.getOwnLineColor();
		...
		if (baseStyle != null)
		{
			IColor lineColor = baseStyle.getLinePen().getLineColor();
			if (lineColor != null)
			{
				return lineColor;
			}
	 ...
	 *
	 */
	public static IColor getLineColor(JRBoxPen boxPen, IColor defaultColor)
	{
		IColor ownLineColor = boxPen.getOwnLineColor();
		if (ownLineColor != null)
		{
			return ownLineColor;
		}
		IColor penLineColor = boxPen.getBox().getPen().getOwnLineColor();
		...
		if (baseStyle != null)
		{
			IColor lineColor = boxPen.getPen(baseStyle.getLineBox()).getLineColor();
			if (lineColor != null)
			{
				return lineColor;
			}
