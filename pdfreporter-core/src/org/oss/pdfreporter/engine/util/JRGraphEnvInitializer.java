 ...
 * @version $Id: JRGraphEnvInitializer.java 5180 2012-03-29 13:23:12Z teodord $
 */
public final class JRGraphEnvInitializer
{
	...
	public static boolean isAwtFontAvailable(String font)
	{
		...
		return AVAILABLE_FONT_FACE_NAMES.contains(font.toLowerCase());//FIXMEFONT not sure if we should check families or fonts
	}
