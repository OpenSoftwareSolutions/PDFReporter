...
public abstract class MaxFontSizeFinder//FIXMETAB deprecate?
{
	...
	public static final MaxFontSizeFinder STYLED_TEXT_MAX_FONT_FINDER = 
		new MaxFontSizeFinder()
		{
			 ...
			 * 
			 */
			public int findMaxFontSize(IAttributedCharacterIterator line, int defaultFontSize)
			{
				line.setIndex(0);
	 ...
	 * 
	 */
	public abstract int findMaxFontSize(IAttributedCharacterIterator line, int defaultFontSize);
}
