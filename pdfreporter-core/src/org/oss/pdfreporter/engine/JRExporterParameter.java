...
public class JRExporterParameter
{
	...
	/**
	 * The IURL that the {@link JasperPrint} object will be read from. If the JasperPrint object is available as a web
	...
	/**
	 * A {@link org.oss.pdfreporter.engine.export.JRExportProgressMonitor JRExportProgressMonitor} instance for monitoring export status. This is useful for users who need to be
	...
	/**
	 * @deprecated Replaced by {@link org.oss.pdfreporter.engine.fonts.FontFamily#getExportFont(String) FontFamily.getExportFont(String)}.
	 */
	...
	/**
	 * The {@link org.oss.pdfreporter.engine.util.FileResolver FileResolver} instance to be used while exporting the report.
	 * @deprecated Replaced by {@link JasperReportsContext}.
	 */
	...
	/**
	 * A {@link org.oss.pdfreporter.engine.export.JRHyperlinkProducerFactory JRHyperlinkProducerFactory} which should be used for custom 
	...
	/**
	 * Instance of the {@link org.oss.pdfreporter.engine.export.ExporterFilter ExporterFilter} interface to be used by the exporter to filter the elements to be exported.
	 */
