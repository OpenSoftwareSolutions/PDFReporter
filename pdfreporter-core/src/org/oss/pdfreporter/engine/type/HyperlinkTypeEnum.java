...
public enum HyperlinkTypeEnum implements JREnum
{
	...
	private HyperlinkTypeEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static HyperlinkTypeEnum getByName(String enumName)
	{
		return (HyperlinkTypeEnum)EnumUtil.getByName(values(), enumName);
	}
