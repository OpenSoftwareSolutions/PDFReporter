...
public enum CalculationEnum implements JREnum
{
	...
	private CalculationEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static CalculationEnum getByName(String enumName)
	{
		return (CalculationEnum)EnumUtil.getByName(values(), enumName);
	}
