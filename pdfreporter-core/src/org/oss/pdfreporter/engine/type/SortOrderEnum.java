...
public enum SortOrderEnum implements JREnum
{
	...
	private SortOrderEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static SortOrderEnum getByName(String enumName)
	{
		return (SortOrderEnum)EnumUtil.getByName(values(), enumName);
	}
