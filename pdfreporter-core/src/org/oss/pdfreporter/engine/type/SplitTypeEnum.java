...
public enum SplitTypeEnum implements JREnum
{
	...
	private SplitTypeEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static SplitTypeEnum getByName(String enumName)
	{
		return (SplitTypeEnum)EnumUtil.getByName(values(), enumName);
	}
