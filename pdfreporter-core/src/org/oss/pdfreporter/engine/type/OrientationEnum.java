...
public enum OrientationEnum implements JREnum
{
	...
	private OrientationEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static OrientationEnum getByName(String enumName)
	{
		return (OrientationEnum)EnumUtil.getByName(values(), enumName);
	}
