...
public enum RenderableTypeEnum implements JREnum
{
	...
	private RenderableTypeEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static RenderableTypeEnum getByName(String enumName)
	{
		return (RenderableTypeEnum)EnumUtil.getByName(values(), enumName);
	}
