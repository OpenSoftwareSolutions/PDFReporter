...
public enum LineStyleEnum implements JREnum
{
	...
	private LineStyleEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static LineStyleEnum getByName(String enumName)
	{
		return (LineStyleEnum)EnumUtil.getByName(values(), enumName);
	}
