...
public enum FooterPositionEnum implements JREnum
{
	...
	private FooterPositionEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static FooterPositionEnum getByName(String enumName)
	{
		return (FooterPositionEnum)EnumUtil.getByName(values(), enumName);
	}
