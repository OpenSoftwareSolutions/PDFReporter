...
public enum IncrementTypeEnum implements JREnum
{
	...
	private IncrementTypeEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static IncrementTypeEnum getByName(String enumName)
	{
		return (IncrementTypeEnum)EnumUtil.getByName(values(), enumName);
	}
