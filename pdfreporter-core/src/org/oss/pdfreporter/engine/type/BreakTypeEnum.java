...
public enum BreakTypeEnum implements JREnum
{
	...
	private BreakTypeEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static BreakTypeEnum getByName(String enumName)
	{
		return (BreakTypeEnum)EnumUtil.getByName(values(), enumName);
	}
