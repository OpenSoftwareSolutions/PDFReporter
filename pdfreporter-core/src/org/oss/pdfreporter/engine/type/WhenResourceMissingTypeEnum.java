...
public enum WhenResourceMissingTypeEnum implements JREnum
{
	...
	private WhenResourceMissingTypeEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static WhenResourceMissingTypeEnum getByName(String enumName)
	{
		return (WhenResourceMissingTypeEnum)EnumUtil.getByName(values(), enumName);
	}
