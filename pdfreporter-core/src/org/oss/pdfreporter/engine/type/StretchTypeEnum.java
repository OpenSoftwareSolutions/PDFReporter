...
public enum StretchTypeEnum implements JREnum
{
	...
	private StretchTypeEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static StretchTypeEnum getByName(String enumName)
	{
		return (StretchTypeEnum)EnumUtil.getByName(values(), enumName);
	}
