 ...
 * @version $Id: RotationEnum.java 4595 2011-09-08 15:55:10Z teodord $
 */
public enum RotationEnum implements JREnum
{
	...
	private RotationEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static RotationEnum getByName(String enumName)
	{
		return (RotationEnum)EnumUtil.getByName(values(), enumName);
	}
