 ...
 * @version $Id: LineSpacingEnum.java 4595 2011-09-08 15:55:10Z teodord $
 */
public enum LineSpacingEnum implements JREnum
{
	...
	private LineSpacingEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static LineSpacingEnum getByName(String enumName)
	{
		return (LineSpacingEnum)EnumUtil.getByName(values(), enumName);
	}
