...
public enum HyperlinkTargetEnum implements JREnum
{
	...
	private HyperlinkTargetEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static HyperlinkTargetEnum getByName(String enumName)
	{
		return (HyperlinkTargetEnum)EnumUtil.getByName(values(), enumName);
	}
