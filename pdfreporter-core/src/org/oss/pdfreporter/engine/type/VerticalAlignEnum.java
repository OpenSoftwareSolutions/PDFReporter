...
public enum VerticalAlignEnum implements JREnum
{
	...
	private VerticalAlignEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static VerticalAlignEnum getByName(String enumName)
	{
		return (VerticalAlignEnum)EnumUtil.getByName(values(), enumName);
	}
