...
public enum RunDirectionEnum implements JREnum
{
	...
	private RunDirectionEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static RunDirectionEnum getByName(String enumName)
	{
		return (RunDirectionEnum)EnumUtil.getByName(values(), enumName);
	}
