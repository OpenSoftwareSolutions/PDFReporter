...
public enum ScaleImageEnum implements JREnum
{
	...
	private ScaleImageEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static ScaleImageEnum getByName(String enumName)
	{
		return (ScaleImageEnum)EnumUtil.getByName(values(), enumName);
	}
