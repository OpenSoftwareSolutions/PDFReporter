...
public enum ImageTypeEnum implements JREnum
{
	...
	private ImageTypeEnum(byte value, String enumName, String mimeType)
	{
		this.value = value;
		this.name = enumName;
	 ...
	 *
	 */
	public static ImageTypeEnum getByName(String enumName)
	{
		return (ImageTypeEnum)EnumUtil.getByName(values(), enumName);
	}
