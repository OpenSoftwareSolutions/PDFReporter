...
public enum BandTypeEnum implements JREnum
{
	...
	private BandTypeEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static BandTypeEnum getByName(String enumName)
	{
		return (BandTypeEnum)EnumUtil.getByName(values(), enumName);
	}
