...
public enum PrintOrderEnum implements JREnum
{
	...
	private PrintOrderEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static PrintOrderEnum getByName(String enumName)
	{
		return (PrintOrderEnum)EnumUtil.getByName(values(), enumName);
	}
