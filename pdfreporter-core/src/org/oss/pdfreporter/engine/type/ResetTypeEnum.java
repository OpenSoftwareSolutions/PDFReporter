...
public enum ResetTypeEnum implements JREnum
{
	...
	private ResetTypeEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static ResetTypeEnum getByName(String enumName)
	{
		return (ResetTypeEnum)EnumUtil.getByName(values(), enumName);
	}
