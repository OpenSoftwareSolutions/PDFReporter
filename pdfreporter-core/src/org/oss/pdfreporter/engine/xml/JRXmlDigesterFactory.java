 ...
 * @version $Id: JRXmlDigesterFactory.java 5726 2012-10-16 15:35:56Z lucianc $
 */
...
///		addMultiAxisDataRules(digester);
	...
	protected static void addComponentRules(IDigester digester)
	{
	...
	protected static void addTemplateRules(IDigester digester)
	{
...
//	}
	...
	private static void addPreDatasetRules(IDigester digester)
	{
		digester.addFactoryCreate("*/dataset", JRElementDatasetFactory.class.getName());
	...
	private static void addCrosstabRules(IDigester digester)
	{
	...
	private static void addFrameRules(IDigester digester)
	{
	...
	private static void addHyperlinkParameterRules(IDigester digester)
	{
...
//	}
	...
	protected static void addExpressionRules(IDigester digester, String expressionPattern,
			String setterMethod)
	{
	 ...
	 *
	 */
	private static class ErrorHandlerImpl implements XMLErrorHandler
	{
