...
public enum CrosstabColumnPositionEnum implements JREnum
{
	...
	private CrosstabColumnPositionEnum(byte value, String enumName)
	{
		this.value = value;
		this.name = enumName;
	}
	 ...
	 *
	 */
	public static CrosstabColumnPositionEnum getByName(String enumName)
	{
		return (CrosstabColumnPositionEnum)EnumUtil.getByName(values(), enumName);
	}
