...
import org.oss.pdfreporter.engine.data.AbstractXmlDataSource;
import org.oss.pdfreporter.engine.data.JRXmlDataSource;
import org.oss.pdfreporter.engine.util.xml.JRXmlDocumentProducer;
import org.oss.pdfreporter.engine.util.xml.JaxenNsAwareXPathExecuter;
...
public class JaxenXmlDataSource extends AbstractXmlDataSource {
	...
	{
		this.documentProducer.setDocumentBuilderFactory(XmlParserUnmarshaller.getDocumentBuilderFactory(documentBuilderFactory));
	}
	...
	public AbstractXmlDataSource subDataSource(String selectExpr)
		...
		subDataSource.setDocumentBuilderFactory(XmlParserUnmarshaller.getDocumentBuilderFactory(documentProducer.getDocumentBuilderFactory()));
