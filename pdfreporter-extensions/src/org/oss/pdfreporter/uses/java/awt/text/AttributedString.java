 ...
 * reader wants to access attributed text through the IAttributedCharacterIterator
 * interface.
 *
 * <p>
 ...
 * cloned.
 *
 * @see IAttributedCharacterIterator
 * @see Annotation
 * @since 1.2
 */
...
public class AttributedString {
     ...
     */
    AttributedString(IAttributedCharacterIterator[] iterators) {
	if (iterators == null) {
     ...
     * text represented by IAttributedCharacterIterator.
     * @param text The text for this attributed string.
     * @exception NullPointerException if <code>text</code> is null.
     */
    public AttributedString(IAttributedCharacterIterator text) {
     ...
     * IAttributedCharacterIterator. If the given range produces an
     ...
     * Constructs an AttributedString instance with the subrange of
     * the given attributed text represented by
     * IAttributedCharacterIterator.  Only attributes that match the
    ...
    /**
     * Creates an IAttributedCharacterIterator instance that provides access to the entire contents of
     * this string.
     *
     * @return An iterator providing access to the text and its attributes.
     */
    public IAttributedCharacterIterator getIterator() {
        return getIterator(null, 0, length());
    }

    /**
     * Creates an IAttributedCharacterIterator instance that provides access to
     ...
     */
    public IAttributedCharacterIterator getIterator(Attribute[] attributes) {
     ...
     */
    public IAttributedCharacterIterator getIterator(Attribute[] attributes, int beginIndex, int endIndex) {
    ...
    // access it without creating an IAttributedCharacterIterator.
    int length() {
        return text.length();
    }
    ...
    final private class AttributedStringIterator implements IAttributedCharacterIterator {
        ...
        // IAttributedCharacterIterator methods. See documentation in that interface.
