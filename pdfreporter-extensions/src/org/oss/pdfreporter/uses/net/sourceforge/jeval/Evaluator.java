...
import org.oss.pdfreporter.uses.net.sourceforge.jeval.function.FunctionGroup;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.function.FunctionResult;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.function.math.MathFunctions;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.function.string.StringFunctions;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.AdditionOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.BooleanAndOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.BooleanNotOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.BooleanOrOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.ClosedParenthesesOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.DivisionOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.EqualOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.GreaterThanOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.GreaterThanOrEqualOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.LessThanOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.LessThanOrEqualOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.ModulusOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.MultiplicationOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.NotEqualOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.OpenParenthesesOperator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.Operator;
import org.oss.pdfreporter.uses.net.sourceforge.jeval.operator.SubtractionOperator;
...
public class Evaluator {
	...
	private String getResult(final Stack operatorStack,
		...
		// Check if the final operand is an operand.
			...
			if (!isExpressionString(resultString)) {
				...
				// Get the final result.
				resultString = String.valueOf(resultDouble.doubleValue());
			} else {
				if (resultExpressionOperand.getUnaryOperator() != null) {
	...
	private void loadSystemVariables() {
		...
		if (loadMathVariables) {
			...
			putVariable("E", String.valueOf(Math.E));
