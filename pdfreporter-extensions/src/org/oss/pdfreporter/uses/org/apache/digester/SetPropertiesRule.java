...
public class SetPropertiesRule extends AbstractRule {
     ...
     */
    @Deprecated
    public SetPropertiesRule(IDigester digester) {
    ...
    public void begin(IAttributes attributes) throws Exception {
        ...
        Object top = digester.peek();
        IRegistry.getIBeansFactory().newBeansUtils().populate(top, values);
